 ...
 */
package mg.rakotobeherinirinaangelo.tpcustomerrakotobeherinirinaangelo.entity;
...
public class Customer implements Serializable {
    ...
    public String toString() {
        return "mg.rakotobeherinirinaangelo.tpcustomerrakotobeherinirinaangelo.entity.Customer[ customerId=" + customerId + " ]";
    }
